<?php 
    ...
    $mat_id = $mat_nombre = $mat_periodo = $mat_docente = $mat_email = "";
    foreach($result->fetchAll(PDO::FETCH_OBJ) as $r){
        $mat_id = $r->id;
        $mat_nombre = $r->nombre;
        $mat_periodo = $r->periodo;
                    ...
                    <div class="card-body">
                        <form action="update.php" method="POST" name="forrol">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="periodo" name="periodo" value="<?= $mat_periodo ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" name="email" value="<?= $mat_email ?>" required>
                            </div>
